...
const features = [
	{
		icon: BarChart3,
		title: 'ERP Tizimi',
		desc: 'Buyurtmalar, moliya va biznes jarayonlarini yagona tizimda boshqaring.',
		color: 'bg-blue-50 text-blue-600',
	},
	{
		icon: Users,
		title: 'CRM Tizimi',
		desc: 'Mijozlar bilan munosabatlarni kuzating, savdo tarixini saqlang.',
		color: 'bg-green-50 text-green-600',
	},
	{
		icon: Warehouse,
		title: 'WMS Tizimi',
		desc: 'Ombor zaxirasini real vaqtda boshqaring va optimallang.',
		color: 'bg-purple-50 text-purple-600',
	},
	{
		icon: ShieldCheck,
		title: 'AWS Bulut',
		desc: 'AWS VPC, SSL/TLS shifrlash va 99.9% uptime kafolati.',
		color: 'bg-gold-50 text-gold-600',
	},
	{
		icon: Zap,
		title: 'Auto-Scaling',
		desc: 'Yuklama oshganda tizim avtomatik kengayadi — tezligi pasaymaydi.',
		color: 'bg-orange-50 text-orange-600',
	},
	{
		icon: Globe,
		title: 'CDN & Tezlik',
		desc: "O'zbekiston bo'ylab barcha foydalanuvchilarga tez yuklanish.",
...
const FeatureIllustrations = {
	'ERP Tizimi': () => (
		<svg
			viewBox='0 0 80 50'
			fill='none'
			className='w-full h-12 mb-3 opacity-80'
		>
	...
	'AWS Bulut': () => (
		...
		>
			<path
				d='M15 35 Q10 35 10 28 Q10 20 18 20 Q20 12 30 14 Q34 8 42 10 Q52 10 52 20 Q60 20 60 28 Q60 35 55 35 Z'
				fill='#FEF3C7'
			/>
			<path
				d='M15 35 Q10 35 10 28 Q10 20 18 20 Q20 12 30 14 Q34 8 42 10 Q52 10 52 20 Q60 20 60 28 Q60 35 55 35 Z'
			...
			/>
			<path
				d='M28 28 L28 42 M32 28 L32 42 M36 28 L36 42 M40 28 L40 42'
				stroke='#D97706'
				strokeWidth='1.5'
				strokeOpacity='0.6'
			/>
	...
	'Auto-Scaling': () => (
		...
		>
			...
			<path
				d='M8 45 Q22 28 36 35 Q50 20 72 12'
				stroke='#F97316'
				strokeWidth='2'
				fill='none'
				strokeDasharray='4 2'
	...
	'CDN & Tezlik': () => (
		...
		>
			...
			/>
			<path
				d='M22 25 Q40 15 58 25'
				stroke='#0F766E'
				strokeWidth='1'
				fill='none'
			/>
			<path
				d='M22 25 Q40 35 58 25'
				stroke='#0F766E'
				strokeWidth='1'
				fill='none'
			/>
...
const testimonials = [
	{
		name: 'Aziz Karimov',
		company: 'Toshkent Kiyim Bozori',
		text: "TekstilHub bizning biznesimizni tubdan o'zgartirdi. Buyurtmalar 3x tezroq ishlanmoqda.",
		tier: 'Platinum',
		rating: 5,
	},
	{
		name: 'Dilnoza Ergasheva',
		company: 'Samarqand Fashion Store',
		text: "WMS tizimi tufayli ombordagi yo'qotishlar 80% kamaydi. Juda samarali!",
		tier: 'Gold',
		rating: 5,
	},
	{
		name: 'Jasur Toshmatov',
		company: 'Namangan Textile Center',
		text: "CRM moduli orqali mijozlarimizni yaxshiroq bilaman. Savdo 40% o'sdi.",
		tier: 'Gold',
		rating: 5,
	},
]
				...
				<div className='max-w-7xl mx-auto px-5 h-16 flex items-center justify-between'>
					<Link to='/' className='flex items-center gap-2'>
						...
						<span className='font-display font-bold text-white text-xl'>
							Remodule<span className='text-gold-400'>.uz</span>
						</span>
					</Link>
					...
					<div className='flex items-center gap-3'>
						<Link
							to='/login'
							className='text-sm font-semibold text-navy-300 hover:text-white px-4 py-2 transition-colors hidden sm:block'
						>
							Kirish
						</Link>
				...
				<div className='relative max-w-7xl mx-auto px-5 py-24 grid lg:grid-cols-2 gap-16 items-center'>
					<div>
						...
						<h1 className='font-display text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] mb-6'>
							Kiyim-Kechak
							<br />
							<span className='text-gold-400'>Ulgurjisi</span> uchun
							<br />
							Smart Tizim
						</h1>
						<p className='text-navy-300 text-lg leading-relaxed mb-10 max-w-lg'>
							ERP, CRM va WMS — uchta tizim bitta platformada. Buyurtmalar,
							mijozlar va ombor zaxirasini real vaqtda boshqaring.
						</p>
						<div className='flex flex-wrap gap-4'>
							...
							<a
								href='#features'
								className='btn-secondary border-navy-600 text-navy-200 hover:bg-navy-700 bg-transparent px-7 py-3 text-base'
							>
								Ko'proq bilish
							</a>
						</div>
					...
					<div className='relative hidden lg:block'>
						...
						<div className='absolute -top-8 -right-4 opacity-20 pointer-events-none'>
							<svg viewBox='0 0 200 200' width='200' height='200' fill='none'>
								...
								/>
								<path
									d='M60 70 L80 55 L100 70 L120 55 L140 70 L140 130 L60 130 Z'
									stroke='#f5a623'
									strokeWidth='1.5'
									fill='none'
									opacity='0.7'
								/>
								<path
									d='M80 55 C80 48 100 44 100 44 C100 44 120 48 120 55'
									stroke='#f5a623'
									strokeWidth='1.5'
									fill='none'
								/>
						...
						<div className='bg-navy-800/80 backdrop-blur rounded-2xl border border-navy-600/30 p-5 shadow-2xl'>
							...
							<div className='grid grid-cols-2 gap-3 mb-4'>
								{[
									...
									<div
										key={label}
										className='bg-navy-700/50 rounded-xl p-3 border border-navy-600/20'
									>
				...
				<div className='max-w-7xl mx-auto px-5'>
					<div className='text-center mb-16'>
						...
						<p className='text-gray-500 text-lg max-w-xl mx-auto'>
							Yagona platforma orqali ERP, CRM va WMS tizimlarini bir joyda
							nazorat qiling.
						</p>
					</div>
						...
						{testimonials.map(({ name, company, text, tier, rating }) => (
							...
							>
								...
								<div className='flex items-center gap-3'>
									...
									<span className={`ml-auto badge ${tierColors[tier]}`}>
										{tier}
									</span>
								</div>
							</div>
